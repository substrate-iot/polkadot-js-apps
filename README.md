...
```
docker run --rm -it --name polkadot-ui -e WS_URL=ws://localhost:9944 -p 8080:80 noux/polkadot-js-apps:0.121.2
```

To build a docker container containing local changes -

```
docker build -t noux/polkadot-js-apps:0.121.2 -f docker/Dockerfile .
```
